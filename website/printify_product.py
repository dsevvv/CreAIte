...
def create_product(blueprint_id=int, print_provider_id=int, variant_id=int, image_id=str):
    payload = {
        "title": "Test Product",
...
def get_product(product_id=str):
    product_get_uri = f'https://api.printify.com/v1/shops/{shop_id}/products/{product_id}.json'
    response = printify_client.request('GET', product_get_uri)
    return response
